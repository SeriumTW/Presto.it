  ...
  <div class="app-modal" data-name="delete">
      <div class="app-modal-container">
          <div class="app-modal-card" data-name="delete" data-modal='0'>
              <div class="app-modal-header">{{__('ui.delete')}}</div>
              <div class="app-modal-body">{{__('ui.notAction')}}</div>
              <div class="app-modal-footer">
                  <a href="javascript:void(0)" class="app-btn cancel">{{__('ui.cancel')}}</a>
                  <a href="javascript:void(0)" class="app-btn a-btn-danger delete">{{__('ui.delete?')}}</a>
              </div>
          </div>
      </div>
  </div>
          ...
          <div class="app-modal-card" data-name="settings" data-modal='0'>
              <form id="update-settings" action="{{ route('avatar.update') }}" enctype="multipart/form-data" method="POST">
                  ...
                  <div class="app-modal-body">
                      ...
                      {{-- Dark/Light Mode  --}}
                      <p class="divider"></p>
                      <p class="app-modal-header">{{__('ui.mode')}} <span class="
                  ...
                  <div class="app-modal-footer">
                      <a href="javascript:void(0)" class="app-btn cancel">{{__('')}}</a>
                      <input type="submit" class="app-btn a-btn-success update" value="{{__('ui.savedMod')}}" />
                  </div>
              </form>
          </div>
      </div>
