    ...
    <div class="container mt-3 mb-5 p-2 radius-10">
        ...
        @if ($announcement)    
            ...
            @elseif (count($announcement->images) == 0)  
                <div class="col-lg-4 col-md-6 col-12 mb-4 d-flex align-items-center justify-content-center">
                    <section class="">
                        <!-- Section: Images -->
                        <section class="">
                            <div class="row">    
            ...
            @endif
                ...
                <div class="col-12 d-flex  justify-content-center align-items-center">
                    <form action="{{route('revisor.accepted', ['id'=>$announcement->id])}}" method="post" class="me-2 me-md-3 me-lg-0">
                        @csrf
                        <button type="submit" class="btn btn-success me-5">{{ __('ui.accetta') }}</button>
                    </form>
                    <form action="{{route('revisor.rejected', ['id'=>$announcement->id])}}" method="post">
                        @csrf
