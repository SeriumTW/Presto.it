<x-layout>
    ...
    <section class="container mt_150 radius-10 shadow-lg p-5 mb-5">
        <div class="row justify-content-center align-items-center">
            <div class="col-12">
                <h3 class="">{{ __('ui.tuttiAnnunci') }}</h3>
            </div>
        </div>
        ...
        <div class="row justify-content-center align-content-center">
            ...
            <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="50" class="col-12 col-md-4 col-lg-3 d-flex justify-content-center my-3">
